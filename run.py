...
if __name__ == '__main__':
    ...
    # summary = runner.run("testcases/order/repayment_info/LGTL.yml")
    ...
    # summary = runner.run("testcases/order/perfect_repayment_info.yml")
    # summary = runner.run("testcases/supply/generate_inventory.yml")
    # summary = runner.run("testcases/usercenter/perfect_userInfo.yml")
    # summary = runner.run("testsuites/develop/repayment_method/repayment.yml")
    ...
    # summary = runner.run("testcases/order/change_contract_suite/change_repayment_method.yml")
